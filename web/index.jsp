...
<html>
    ...
    <body>
        <%
            ...
            out.print("<br>OpenDocument=" + result); 
            result = _MyDocument.AddChapter("Capitolo", "c1");
            out.print("<br>AddChapter=" + result); 
            result = _MyDocument.AddParagraph("Paragrafo ","h1");
            out.print("<br>AddParagraph=" + result); 
            result = _MyDocument.AddParagraph("Paragrafo ","h1");
            out.print("<br>AddParagraph=" + result); 
            result = _MyDocument.AddParagraph("Paragrafo ","h1");
            out.print("<br>AddParagraph=" + result); 
            ...
            out.print("<br>OpenTable=" + result); 
            result = _MyDocument.AddCell("prova","ce1",2,1);
            out.print("<br>AddCell=" + result); 
            result = _MyDocument.AddCell("prova","ce1",2,1);
            out.print("<br>AddCell=" + result); 
            result = _MyDocument.AddCell("prova","ce1",2,1);
            out.print("<br>AddCell=" + result); 
